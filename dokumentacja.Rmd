...
\begin{enumerate}
\item Posiadaj Pythona 3.7.9.
\item Zainstaluj potrzebne pakiety komendą `pip install -r requirements.txt`.
\end{enumerate}
        1. Posiadaj Pythona 3.7.9.
    2. Zainstaluj potrzebne pakiety komendą `pip install -r requirements.txt`.
    3. Uruchom program main.py `python main.py`.
...
![Schemat bazy danych](assets/schemat_obraz.jpg "Schemat bazy danych")
