...
if __name__ == "__main__":
    ...
    address_tbl = generate_address_tbl()
    ...
    with engine.connect() as connection:
        with open("src/create.sql", "r") as file:
        ...
        address_tbl.to_sql("Addresses", con =  connection, if_exists='append', index=False)
        ...
        payments_tbl.to_sql("Finances", con =  connection, if_exists='append', index=False)
        payoffs_tbl.to_sql("Payoffs", con =  connection, if_exists='append', index=False)
