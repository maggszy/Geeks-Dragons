...
<!-- #można dać tabelę z ilością dni na wypożyczeniu(tutaj by była lista) i ilością wypożyczeń danej gry -->
...
Najbardziej dochodową grą z wypożyczeń była gra **`r rentals_df3_10$title[10]`**. Wypożyczono ją **`r as.numeric(rentals_df3_10$game_num[10])`**. Dochód z niej wyniósł **`r rentals_df3_10$dochod[10]`zł**.
